...
GAME_SOCKET_IP = '127.0.0.1'

#UDP
socket_client = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
socket_client.bind((GAME_SOCKET_IP, GAME_SOCKET_PORT))
print(f"UDP client bound to {GAME_SOCKET_IP}:{GAME_SOCKET_PORT}")
...
def run_mp(input_stream1, input_stream2, P0, P1):
    ...
    while True:
        ...
        if results1.pose_landmarks:
            ...
            sendable = False #if no keypoints are found, do not send data to server
        ...
        if sendable: # clearly it wasn't just -1 -1 -1 etc.
            socket_client.sendto(json.dumps(frame_p3ds.tolist()).encode(), (GAME_SOCKET_IP, GAME_SOCKET_PORT))
            sendable = True
